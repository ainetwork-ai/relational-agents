  ...
  if (!hasDash) {
    ...
    await api("POST", `/api/databases/${journal.id}/views`, {
      ...
      config: { widgets: [
        ...
        { id: "w-price", kind: "chart", width: 3, chartType: "candles", bucket: "hour", xPropertyId: P("Date"), yPropertyId: P("Fill price"), markerPropertyId: P("Side"), title: "Fill price · hourly candles · buy/sell markers" },
        { id: "w-depth", kind: "depth", width: 1, groupByPropertyId: P("Side"), xPropertyId: P("Fill price"), aggregate: "sum", aggregatePropertyId: P("Amount"), title: "Filled volume by price" },

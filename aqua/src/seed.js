  ...
  if (!hasDash) {
    ...
    await api("POST", `/api/databases/${journal.id}/views`, {
      ...
      config: { widgets: [
        ...
        { id: "w-price", kind: "chart", width: 4, chartType: "candles", bucket: "hour", xPropertyId: P("Date"), yPropertyId: P("Fill price"), markerPropertyId: P("Side"), title: "Fill price · hourly candles · buy/sell markers" },
